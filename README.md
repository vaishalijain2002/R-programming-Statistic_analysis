...
# Channel 4 Analysis Script (Revised 12/17/24)
...
4. **Process Channels**: The script processes the CH1, CH2, and CH3 TIFF files (Red, Green, and Blue).
    ...
    - The ROIs are measured for each channel. - The results are copied to the "Results" window and can be saved to Excel.
